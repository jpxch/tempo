          ...
          >
            <div className="flex flex-col gap-3 comfort:gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <button
                ...
                className="min-h-11 rounded-full border border-white/10 px-4 py-2 text-sm text-neutral-300 transition comfort:min-h-12 comfort:px-5 comfort:py-3 comfort:text-base hover:border-violet-300 hover:text-white"
              >
                Mark done
              </button>
            </div>
